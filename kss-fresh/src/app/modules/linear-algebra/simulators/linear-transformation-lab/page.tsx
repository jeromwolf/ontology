...
const LinearTransformationLab = dynamic(
  () => import('@/components/linear-algebra-simulators/LinearTransformationLab'),
  { ssr: false }
)

export default function LinearTransformationLabPage() {
  return (
