...
const FeatureEngineeringLabPyCaret = dynamic(
  () => import('../../components/simulators/FeatureEngineeringLabPyCaret'),
  { 
    ssr: false,
    loading: () => (
...
export default function FeatureEngineeringLabPyCaretPage() {
  return (
