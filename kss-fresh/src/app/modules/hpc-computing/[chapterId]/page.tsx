...
export default function HPCComputingChapterPage() {
  ...
  if (!currentChapter) {
    router.push('/modules/hpc-computing')
    return null
  }
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-4">
          <Link href="/modules/hpc-computing" className="hover:text-yellow-600 dark:hover:text-yellow-400">
            HPC Computing
          </Link>
          <span>/</span>
      ...
      <div className="flex justify-between items-center mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
        {prevChapter ? (
          <Link
            href={`/modules/hpc-computing/${prevChapter.id}`}
        ...
        {nextChapter ? (
          <Link
            href={`/modules/hpc-computing/${nextChapter.id}`}
            className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-yellow-600 dark:hover:text-yellow-400 transition-colors"
          >
          ...
          <Link
            ...
            className="flex items-center gap-2 text-yellow-600 dark:text-yellow-400 hover:text-yellow-700 dark:hover:text-yellow-500 transition-colors"
          >
            <div className="text-right">
