...
interface LangChainLayoutProps {
  children: ReactNode
}

export default function LangChainLayout({ children }: LangChainLayoutProps) {
  return (
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
              <div className="flex items-center gap-1">
                <Clock size={16} />
                <span>{langchainModule.estimatedHours}시간</span>
              </div>
              <div className="flex items-center gap-1">
                <Search size={16} />
                <span className="capitalize">{langchainModule.difficulty}</span>
              </div>
              <div className="flex items-center gap-1">
                <BookOpen size={16} />
                <span>{langchainModule.chapters.length}개 챕터</span>
              </div>
            </div>
          </div>
        </div>
