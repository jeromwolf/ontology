...
export default function ChapterContent({ chapterId }: ChapterContentProps) {
  ...
  const renderContent = (): ReactNode => {
    switch (chapterId) {
      case '01-langchain-basics':
        return <Chapter1 />
      case '02-chains-prompts':
        return <Chapter2 />
      case '03-memory-context':
        return <Chapter3 />
      case '04-agents-tools':
        return <Chapter4 />
      case '05-langgraph-intro':
        return <Chapter5 />
      case '06-complex-workflows':
        return <Chapter6 />
      case '07-production-deployment':
        return <Chapter7 />
      case '08-real-world-projects':
        return <Chapter8 />
      default:
