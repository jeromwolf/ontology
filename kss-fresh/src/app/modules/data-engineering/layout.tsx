...
interface DataEngineeringLayoutProps {
  children: ReactNode
}

export default function DataEngineeringLayout({ children }: DataEngineeringLayoutProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900/20">
      {/* Header */}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-600 to-blue-700 flex items-center justify-center text-white text-xl">
                  {moduleMetadata.icon}
                </div>
                <div>
