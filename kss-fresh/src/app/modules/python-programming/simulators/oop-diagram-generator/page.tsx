...
import { ArrowLeft, Box, Code, Play, CheckCircle2 } from 'lucide-react'

export default function OOPDiagramGeneratorPage() {
  return (
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Analyze Python code and extract class structures automatically
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Create professional UML class diagrams with inheritance and relationships
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Modify diagrams and see code changes in real-time
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Save diagrams as PNG, SVG, or PlantUML format
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">Code Parser - In Progress</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-5 h-5 rounded-full border-2 border-gray-300" />
                  <span className="text-gray-500 dark:text-gray-500">Diagram Rendering - Planned</span>
                </div>
              </div>
            </div>
          </div>
