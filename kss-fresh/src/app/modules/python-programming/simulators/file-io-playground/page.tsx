...
import { ArrowLeft, FileText, Code, Play, CheckCircle2 } from 'lucide-react'

export default function FileIOPlaygroundPage() {
  return (
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Practice open(), read(), write(), readline(), readlines()
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Work with structured data formats using csv and json modules
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Learn pathlib and os.path for file system navigation
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Simulate file operations without affecting your real file system
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">Virtual File System - In Progress</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-5 h-5 rounded-full border-2 border-gray-300" />
                  <span className="text-gray-500 dark:text-gray-500">Advanced Operations - Planned</span>
                </div>
              </div>
            </div>
          </div>
