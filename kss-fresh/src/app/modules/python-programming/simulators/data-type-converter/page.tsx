...
import { ArrowLeft, Shuffle, Code, Play, CheckCircle2 } from 'lucide-react'

export default function DataTypeConverterPage() {
  return (
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Visualize type conversions and operations
              </p>
            </div>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    See how Python converts between int, float, str, bool, list, tuple, dict
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Interactive examples of isinstance(), type(), and type hints
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Learn about type coercion mistakes and how to avoid them
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Compare memory and speed implications of different types
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">Conversion Logic - In Progress</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-5 h-5 rounded-full border-2 border-gray-300" />
                  <span className="text-gray-500 dark:text-gray-500">Visualization Engine - Planned</span>
                </div>
              </div>
            </div>
          </div>
