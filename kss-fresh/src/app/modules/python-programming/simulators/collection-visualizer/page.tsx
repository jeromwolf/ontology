...
import { ArrowLeft, Database, Code, Play, CheckCircle2 } from 'lucide-react'

export default function CollectionVisualizerPage() {
  return (
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
                Collection Operations Visualizer
              </h1>
              <p className="text-gray-600 dark:text-gray-400">
                Interactive list, dict, and set operations
              </p>
            </div>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Visualize append, extend, insert, remove, pop, sort, slice operations
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Interactive examples of keys, values, items, get, update, pop
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Visual demonstrations of union, intersection, difference, symmetric_difference
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Step-by-step visualization of list/dict/set comprehensions
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">Animation Engine - In Progress</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-5 h-5 rounded-full border-2 border-gray-300" />
                  <span className="text-gray-500 dark:text-gray-500">Interactive Controls - Planned</span>
                </div>
              </div>
            </div>
          </div>
