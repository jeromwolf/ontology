...
interface OptimizationTheoryLayoutProps {
  children: ReactNode
}

export default function OptimizationTheoryLayout({ children }: OptimizationTheoryLayoutProps) {
  return (
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-600 to-teal-700 flex items-center justify-center text-white text-xl">
                  {moduleMetadata.icon}
                </div>
                <div>
